...
<div class="bg-gray-200 p-2 sm:p-3 rounded shadow mb-4 ml-[5%] max-w-full sm:max-w-4xl">
    ...
    <div class="bg-gray-200 p-2 sm:p-3 rounded shadow mb-4">
        ...
        <form action="{{ route('import.students') }}" method="POST" enctype="multipart/form-data" class="max-w-xl mx-auto">
            ...
            <div class="flex justify-center items-center">
                <button type="submit" class="bg-[#FF161F] text-white px-3 py-1 rounded-md hover:bg-red-800 transition-colors duration-300">Importar Estudantes</button>
            </div>
        </form>
    </div>
    ...
    <form action="{{ route('teacher.config.filter') }}" method="POST" class="mb-4 ml-auto max-w-xl">
        ...
        <div class="flex items-center justify-between space-x-2">
            ...
            <button type="submit" class="bg-[#FF161F] text-white px-3 py-1 rounded-md hover:bg-red-800 transition-colors duration-300">Filtrar</button>
        </div>
    </form>
    ...
    <form action="{{ route('teacher.config.delete_class') }}" method="POST" class="mb-4 ml-auto max-w-xl">
        ...
        <div class="flex items-center justify-between space-x-2">
            ...
            <button type="submit" class="bg-[#FF161F] text-white px-3 py-1 rounded-md hover:bg-red-800 transition-colors duration-300">Deletar Classe</button>
        </div>
    </form>
</div>
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <td class="px-2 py-1 border flex items-center justify-start text-xs sm:text-sm">
                        ...
                        <button type="button" class="bg-[#FF161F] text-white px-2 py-1 rounded-md" onclick="openDeleteModal('student', '{{ $student->id }}')">Excluir</button>
                    </td>
                </tr>
                @endforeach
                <form action="{{ route('students.store') }}" method="POST">
                    ...
                    <tr>
                        ...
                        <td class="py-1 border flex justify-center items-center">
                            <button type="submit" class="bg-[#FF161F] text-white px-3 py-1 rounded-md">Adicionar</button>
                        </td>
                    </tr>
                </form>
            </tbody>
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <td class="px-2 py-1 border flex items-center justify-start">
                        ...
                        <button type="button" class="bg-[#FF161F] text-white px-2 py-1 rounded-md" onclick="openDeleteModal('secretary', '{{ $secretary->id }}')">Excluir</button>
                    </td>
                </tr>
                @endforeach
    ...
    <div class="block sm:hidden">
        ...
        <div class="border-b border-gray-300 p-2">
            ...
            <div class="flex items-center mt-2">
                ...
                <button type="button" class="bg-[#FF161F] text-white px-2 py-1 rounded-md" onclick="openDeleteModal('location', '{{ $location->id }}')">Excluir</button>
            </div>
        </div>
        @endforeach
        <form action="{{ route('locations.store') }}" method="POST">
