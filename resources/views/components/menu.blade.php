    ...
    <header class="header">
        ...
        <div class="header-icons">
            ...
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button class="fas fa-sign-out-alt logout-icon" title="Logout" id="logout-button" style="background-color: #842519; color: white; cursor: pointer; transition: none;"></button>
            </form>
        </div>
    </header>
